...
MODULE att
   ...
   CHARACTER(LEN=lc), DIMENSION(ip_maxdum), SAVE :: cm_dumatt !< dummy attribute
...
CONTAINS
   ...
   SUBROUTINE att_get_dummy( cd_dummy )
      ...
      ! loop indices
      ! namelist
      CHARACTER(LEN=lc), DIMENSION(ip_maxdum) :: cn_dumvar
      CHARACTER(LEN=lc), DIMENSION(ip_maxdum) :: cn_dumdim
      CHARACTER(LEN=lc), DIMENSION(ip_maxdum) :: cn_dumatt
