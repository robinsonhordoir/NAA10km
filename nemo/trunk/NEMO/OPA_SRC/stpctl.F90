...
CONTAINS
   ...
   SUBROUTINE stp_ctl( kt, kindic )
      ...
      REAL(wp) ::   zemax,zumax, zsmin, zssh2     ! temporary scalars
      ...
      IF( zumax > 20.e0 .OR. zemax /= zemax .OR. zumax /= zumax ) THEN
         ...
         IF(lwp) THEN
            ...
            WRITE(numout,*) ' stpctl: the zonal velocity is larger than 20 m/s or NaN'
            WRITE(numout,*) ' ====== '
