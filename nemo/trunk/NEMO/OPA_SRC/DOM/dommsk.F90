...
!         ii0 = 145   ;   ii1 = 146   ;   fmask( mi0(ii0):mi1(ii1) , mj0(ij0):mj1(ij1) , 1:jpk ) = 4._wp
      ...
      ENDIF
      !Robinson
!!$      IF( cp_cfg == "aa_10km" .AND. jp_cfg == 10 ) THEN   ! NAA10km configuration
!!$         !                                                ! Increased lateral friction near of some straits
!!$        IF(lwp) WRITE(numout,*) '      Canadian Archipelago Strait'
!!$        ii0 = 314           ;   ii1 =  335        ! North Kent Island Strait 
!!$        ij0 = 476           ;   ij1 =  489           ;   fmask( mi0(ii0):mi1(ii1),mj0(ij0):mj1(ij1),1:jpk ) = 2._wp 
!!$      ENDIF
      !Robinson
